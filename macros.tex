...
%% semantics configuration like <skip, s>
\newcommand*{\config}[2]{\langle\ #1,\ #2\ \rangle}
%% denotational semantics configuration C[com](s)
...
%% denotational semantics configuration C[com] without state
\newcommand*{\denotCsl}[1]{\calC \llbracket #1 \rrbracket}
\newcommand*{\denotBsl}[1]{\calB \llbracket #1 \rrbracket}
%% while assignment :=
\newcommand*{\wass}{:=}
%% semantics puntual substitution s[x -> n]
\newcommand*{\assign}[3]{#1[#2\mapsto#3]}
\newcommand*{\bigassign}[3]{#1\bigl[#2\mapsto#3\bigr]}
...
\newcommand*{\funcomp}[2]{\mathrm{#1}\mathop{\circ}\mathrm{#2}}
% e per if then else
